...
*/
const ImageView = ({ Src, Caption, HandleChange }) => {
    ...
    const handleInputChange = (ev) => { HandleChange(ev, setCaption) }
    ...
    const handleBlur = (ev) => {
        ...
        HandleChange(caption); // Passing caption up to parent component
    };
